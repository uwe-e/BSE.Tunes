...
{
    public class SearchCategoryTracksPageViewModel : ViewModelBase, INavigationAware
    {
        ...
        public SearchCategoryTracksPageViewModel(IDataService dataService, INavigationService navigationService, IResourceService resourceService)
        {
                ...
                this.Items = new IncrementalObservableCollection<DataItemViewModel>(
                    ...
                    (uint count) =>
                    {
                        Func<Task<Windows.UI.Xaml.Data.LoadMoreItemsResult>> taskFunc = async () =>
                        {
                            ...
                            ObservableCollection<Track> trackResults = await this.m_dataService.GetTrackSearchResults(query);
