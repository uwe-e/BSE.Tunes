...
{
    public class HostSettingsRedirectorUserControlViewModel : ViewModelBase
    {
        ...
        public HostSettingsRedirectorUserControlViewModel(INavigationService navigationService)
        {
        ...
        {
            this.m_navigationService.Navigate(typeof(HostSettingsPage));
        }
        #endregion
    }
}
